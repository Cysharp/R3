...
{
    /// <summary>Returns a <see cref="CancellationToken"/> that cancels when <paramref name="node"/> emits <see cref="Node.SignalName.TreeExited"/>.</summary>
    ...
    {
        return node.SignalAsObservable(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5, T6>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5, T6, T7>(signalName, node.CancelOnExitTree());
    }
    ...
    {
        return node.SignalAsObservable<T0, T1, T2, T3, T4, T5, T6, T7, T8>(signalName, node.CancelOnExitTree());
    }
