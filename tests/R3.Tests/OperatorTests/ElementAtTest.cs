...
public class ElementAtTest
{
    ...
    public async Task ElementAt()
    {
        ...
        await Assert.ThrowsAsync<Exception>(async () => await Event.Throw<int>(new Exception()).ElementAtAsync(0));

        // empty case
        await Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await Event.Empty<int>().ElementAtAsync(0));
    }
    ...
    public async Task ElementAtOrDefault()
    {
        ...
        await Assert.ThrowsAsync<Exception>(async () => await Event.Throw<int>(new Exception()).ElementAtOrDefaultAsync(0));

        // empty case
        (await Event.Empty<int>().ElementAtOrDefaultAsync(0, 99999)).Should().Be(99999);
    }
    ...
    public async Task ElementAtIndex()
    {
        ...
        await Assert.ThrowsAsync<Exception>(async () => await Event.Throw<int>(new Exception()).ElementAtAsync(new Index(0)));

        // empty case
        await Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await Event.Empty<int>().ElementAtAsync(new Index(0)));
        ...
        await Assert.ThrowsAsync<Exception>(async () => await Event.Throw<int>(new Exception()).ElementAtAsync(^1));
        await Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await Event.Empty<int>().ElementAtAsync(^1));
    }
    ...
    public async Task ElementAtOrDefaultIndex()
    {
        ...
        await Assert.ThrowsAsync<Exception>(async () => await Event.Throw<int>(new Exception()).ElementAtOrDefaultAsync(new Index(0)));

        // empty case
        (await Event.Empty<int>().ElementAtOrDefaultAsync(new Index(0))).Should().Be(0);
        ...
        await Assert.ThrowsAsync<Exception>(async () => await Event.Throw<int>(new Exception()).ElementAtOrDefaultAsync(^1));
        (await Event.Empty<int>().ElementAtOrDefaultAsync(^1, 9999)).Should().Be(9999);
    }
}
